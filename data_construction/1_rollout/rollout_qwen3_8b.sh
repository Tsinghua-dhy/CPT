...
# Qwen3-8B Rollout Script
# Easy/Medium: 4x rollout, max_tokens=2048
# Hard/Very_hard: 8x rollout, max_tokens=4096
# Run 2 vLLM instances concurrently

# model list
models=(
    Qwen/Qwen3-8B-Base
    # Add more 8B model paths
)
...
echo "========================================"
echo "Qwen3-8B Rollout Evaluation"
echo "========================================"
echo "Models: ${#models[@]}"
echo "Data: $src_file"
echo "GPU 0: $gpu_id_0"

...
# Qwen3-14B Rollout Script
# Easy/Medium: 2x rollout, max_tokens=2048
# Hard/Very_hard: 4x rollout, max_tokens=4096
# Run 2 vLLM instances concurrently

# model list
models=(
    Qwen/Qwen3-14B-Base
    # Add more 14B model paths
)
...
echo "========================================"
echo "Qwen3-14B Rollout Evaluation"
echo "========================================"
echo "Models: ${#models[@]}"
echo "Data: $src_file"
echo "GPU 0: $gpu_id_0"

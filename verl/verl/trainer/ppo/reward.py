...
def load_reward_manager(config, tokenizer, num_examine, **reward_kwargs):
    ...
    # Get overlong_buffer config if available
    overlong_buffer_config = config.reward_model.get("overlong_buffer", {})
    max_response_length = config.data.get("max_response_length", 8192)
    ...
    return reward_manager_cls(
        ...
        overlong_buffer_config=overlong_buffer_config,
